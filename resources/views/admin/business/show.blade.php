        ...
        <div class="w-full bg-white shadow-lg p-5 flex">
            <div class="w-1/2 pr-5">
                <div class="flex justify-between">
                    <h3 class="text-lg font-semibold mb-5">Dati Aziendali</h3>
                    @if ($business->logo)
                ...
                <div class="flex flex-col gap-1">
                    ...
                    <hr class="py-1">
                    <a href="{{route('show_business', ['subdomain' => $business->subdomain])}}">
            ...
            <div class="w-1/2 border-l pl-5">
                <h3 class="text-lg font-semibold mb-5 uppercase">Utenti aziendali</h3>
                ...
                <div>
                    ...
                    @else
                        <p>Nessun Collaboratore presente al momento..</p>
                    @endif
                </div>
            </div>
