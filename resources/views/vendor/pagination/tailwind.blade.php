                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="relative inline-flex items-center px-4 py-2 text-sm font-medium text-white rounded-br-full rounded-tl-full bg-green-800/60 mx-1 cursor-default leading-5">{{ $page }}</span>
                                    </span>
                                @else
